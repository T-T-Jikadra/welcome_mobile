...
class printSalesInvoice extends StatefulWidget {
  printSalesInvoice({Key? mykey, salesModel? Data}) : super(key: mykey) {
    xModel = Data;
  }
  ...
  @override
  _printSalesInvoiceState createState() => _printSalesInvoiceState();
}
...
class _printSalesInvoiceState extends State<printSalesInvoice> {
  ...
  Future<void> getPdf() async {
    var path = await generateSalesInvoicePdf(widget.xModel);
    setState(() {
      pdfFilePath = path;
    });
  }
  ...
  Future<void> _generatePdf() async {
    ...
    final file = File(
        '${outputDir.path}/Welcome Mobile_Sales_Invoice_${widget.xModel!.id}.pdf');
          ...
          children: [
            ...
            pw.Table(
              ...
              children: [
                ...
                _buildInvoiceRow(widget.xModel!.company, widget.xModel!.id,
                    widget.xModel!.wardays, widget.xModel!.itemname, true),
              ],
            ),
